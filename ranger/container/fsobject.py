...
DOCUMENT_WWW = ('html', 'htm', 'xhtml', 'shtml')
...
class FileSystemObject(  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def set_mimetype(self):
        ...
        self.www       = self.extension in DOCUMENT_WWW

        # pylint: disable=attribute-defined-outside-init
        keys = ('video', 'audio', 'image', 'media', 'ebooks', 'www', 'document', 'mimetext', 'special', 'container')
    ...
    def load(self):  # pylint: disable=too-many-statements
        ...
        if fmt in (0o020000, 0o060000):  # stat.S_IFCHR/BLK
            ...
            if new_stat:
                ...
                self.infostring = ' ' + human_readable(self.size, use_opt=True, uni_format=True)
            else:
                self.size = 0
                self.infostring = '?'
